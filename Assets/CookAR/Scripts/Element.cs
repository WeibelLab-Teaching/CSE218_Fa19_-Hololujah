...
namespace CookARmain
{
    public class Element : MonoBehaviour
    {
        ...
        public TextMesh ElementSpectralImage;
        ...
        public void insertImage(RawImage UIicon,TextMeshProUGUI ElementDes,string extension)
        {
            Texture2D othericon = Resources.Load<Texture2D>("Textures/Dataset_Images/" + ElementNameDetail.text);

            Debug.Log("Assets/MRDL_PeriodicTable/Textures/Dataset_Images/" + ElementNameDetail.text);
        ...
        public void SetFromElementData(ElementData data, Dictionary<string, Material> typeMaterials)
        {
            ...
            ElementSpectralImage.text = data.spectral_img;
            ElementName.text = data.symbol;
            ElementNameDetail.text = data.name;
            
            List<string> MaterialEditorExtensions = new List<string>(new string[] { ".jpg", ".jpeg",".webp"});
           
            /*
            Texture2D othericon = (Texture2D)AssetDatabase.LoadAssetAtPath("Assets/MRDL_PeriodicTable/Textures/Dataset_Images/" + ElementNameDetail.text + ".jpg", typeof(Texture2D));
            ...
            */
            foreach (string ext in MaterialEditorExtensions) {
                insertImage(UIicon, ElementDescription, ext);
            }
